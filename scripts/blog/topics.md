<!--
  Queue of post ideas. Each run takes the first unchecked one and ticks it.
  When there is nothing left, Gemini picks a topic on its own (see persona.md).
...
- [ ] Reading progress bars and scroll effects with zero JavaScript: CSS scroll-driven animations
- [ ] How I use AI in my frontend workflow without letting it write my whole app
